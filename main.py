...
movie6 = Movie('Titanic','James Cameron','Romance',['Leonardo DiCaprio','Kate Winslet'])
...
print(f'Peak hours gia to cinmea2: {cinema2.calculatePeak()}')
...
cinema1.setMaxForecast(25)
cinema2.setMaxForecast(21)
